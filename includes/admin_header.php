...
<head>
    ...
    <link rel="stylesheet" href="/bus/assets/css/admin.css">
    <link
        rel="stylesheet"
    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <div class="sidebar-footer">
                <a href="/bus/admin/logout.php" class="sidebar-logout">
